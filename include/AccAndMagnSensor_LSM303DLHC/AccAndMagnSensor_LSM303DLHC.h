// -*- C++ -*-
/*!
 * @file  AccAndMagnSensor_LSM303DLHC.h
...
#ifndef ACCANDMAGNSENSOR_LSM303DLHC_H
#define ACCANDMAGNSENSOR_LSM303DLHC_H
...
/*!
 * @class AccAndMagnSensor_LSM303DLHC
 * @brief AccAndMagnSensor_LSM303DLHC
 *
 * 加速度・地磁気6軸センサLSM303DLHCで加速度と地磁気を検出してData
 * OutPortから出力するRTCです。
 *
 */
class AccAndMagnSensor_LSM303DLHC
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  AccAndMagnSensor_LSM303DLHC(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~AccAndMagnSensor_LSM303DLHC();
...
extern "C"
{
  DLL_EXPORT void AccAndMagnSensor_LSM303DLHCInit(RTC::Manager* manager);
};

#endif // ACCANDMAGNSENSOR_LSM303DLHC_H
